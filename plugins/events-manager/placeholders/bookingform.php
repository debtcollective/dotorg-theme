...
?>
<div id="em-booking" class="rsvp__form">
	<?php
				...
				<?php if ( $can_book ) : ?>
					<div class='rsvp__form-details'>
						...
						if ( $show_tickets && $available_tickets_count == 1 && ! get_option( 'dbem_bookings_tickets_single_form' ) ) {
							...
							em_locate_template(
								'forms/bookingform/ticket-single.php',
								true,
								array(
									'EM_Event'  => $EM_Event,
									'EM_Ticket' => $EM_Ticket,
						...
						<div class="em-booking-buttons">
							...
							<input type="submit" class="button-primary btn" id="em-booking-submit" value="<?php echo esc_attr( get_option( 'dbem_bookings_submit_button' ) ); ?>" />
							<?php endif; ?>
						</div>
