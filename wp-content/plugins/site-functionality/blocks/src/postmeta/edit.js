...
const Edit = ( props ) => {
    ...
    const SettingsPanel = () => {
		return (
			<InspectorControls>
				<PanelBody title={ __( 'Field Options', 'site-functionality' ) }>
					<PanelRow>
						<FieldSelector />
					</PanelRow>
					<PanelRow>
    ...
    const RenderField = () => {
        ...
        switch( type ) {
            ...
            case 'currency' :
                return (
                    new Intl.NumberFormat( localeString, { style: 'currency', currency: 'USD' } ).format( value )
                )
            case 'date' :
                return (
            ...
            case 'file' :
                ...
                return (
                    <a href={ file?.source_url || value }>{ label || file?.source_url }</a>
                )
            case 'number' :
                return (
