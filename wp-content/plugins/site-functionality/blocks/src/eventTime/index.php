<?php
/**
 * Server-side rendering of the `site-functionality/event-time` block.
 *
 * @package WordPress
 */
namespace Site_Functionality\Blocks\Event_Time;

/**
 * Renders the `site-functionality/event-time` block on the server.
 *
