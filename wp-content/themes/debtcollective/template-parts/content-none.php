...
?>
	...
	<section class="no-results not-found">
		...
		<header class="page-header">
			<h1 class="page-title"><?php esc_html_e( 'Nothing Found', 'debtcollective' ); ?></h1>
		</header><!-- .page-header -->
			...
			<?php if ( is_home() && current_user_can( 'publish_posts' ) ) : ?>
				...
				printf(
					wp_kses(
						...
						esc_html__( 'Ready to publish your first post? <a href="%1$s">Get started here</a>.', 'debtcollective' ),
						[
							'a' => [
								'href' => [],
							],
