...
<section class="section-scaffolding">
	...
	<h2 class="scaffolding-heading"><?php esc_html_e( 'Typography', 'debtcollective' ); ?></h2>
	...
	debtcollective_display_scaffolding_section(
		[
			...
			'usage'       => '<del>Debt Collective</del>',
			'output'      => '<p>We use <del>Debt Collective</del> wd_s to build themes.</p>',
		]
	);
